...
export default function Shop() {
  ...
  let { search, page } = useSelector(state => ({ ...state }));
  const { text } = search;

  console.log('shop page', page);
  ...
  // 9. show products base on shipping yes/no
  const showShipping = () => (
    <>
      <Checkbox
        className="pb-2 pl-4 pr-4"
